...
export const contract = {
	...
	destroyedTicket: '연소 한 연료',
	rapidParticipation: '빠 른 참여',
	numberOfParticipants: '참여 자산 수량',
	pleaseInputEthQuantity: 'TRX 수량 을 입력 하 세 요',
	instantInvolvement: '지금 바로 참여 하 겠 습 니 다.',
	need: '필요 한 연료 비',
...
export const minimumPlayer = '참여 하여 들어오다';
export const waitingForReturn = '귀환 을 기다리다';
// export const transactionConfirmed = '交易已确认';
export const transactionConfirmed = '지능 계약 이미 촉발';
export const assets = '자산.';
